	...
	>
		...
		<div className="border-t border-gray-100 bg-gray-50/50 p-4 flex items-center gap-2">
			...
			<div className="flex gap-2">
				<Button
					variant="ghost"
					className="w-12 h-12 p-0 rounded-2xl text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 border border-transparent hover:border-indigo-100 transition-all duration-200"
					onClick={() => onEdit(brand)}
					title="Edit Brand"
				>
					<FiEdit2 className="w-6 h-6 mx-auto" />
				</Button>
				<Button
					variant="ghost"
					className="w-12 h-12 p-0 rounded-2xl text-gray-400 hover:text-rose-600 hover:bg-rose-50 border border-transparent hover:border-rose-100 transition-all duration-200"
