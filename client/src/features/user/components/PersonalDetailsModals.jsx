    ...
    <>
        ...
        <Modal isOpen={isUploadModalOpen} onClose={() => { if (!isUploadingAvatar) { setIsUploadModalOpen(false); clearFileSelection(); } }} title="Upload Profile Image" size="sm">
            <div className="space-y-6">
                <div className={`relative aspect-square rounded-3xl overflow-hidden border-2 border-dashed ${previewUrl ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200 bg-gray-50'} flex flex-col items-center justify-center transition-all duration-300`}>
                    {previewUrl ? (
                        <>
        ...
        <Modal isOpen={isDeleteModalOpen} onClose={() => setIsDeleteModalOpen(false)} title="Delete Profile Image" size="sm">
            <div className="space-y-6">
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-gray-500 mt-2">Do you really want to delete your profile image? This action cannot be undone.</p>
                </div>
                <div className="flex gap-3">
        ...
        <Modal isOpen={isAccountDeleteModalOpen} onClose={() => setIsAccountDeleteModalOpen(false)} title="Deactivate Account" size="sm">
            <div className="space-y-6">
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-gray-500 mt-2 text-sm leading-relaxed px-4">This will deactivate your account and hide your profile. You can reactivate it later by logging back in.</p>
                </div>
                <div className="flex gap-3">
