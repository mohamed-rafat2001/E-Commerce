...
Modeled after features/product/pages/ProductsPage.jsx and reused filter composition from BrandsFilter.
This keeps identical top-bar behavior, spacing, and URL-driven filtering interactions
used by existing listing pages.
*/
	...
	return (
		<div className="border-b border-gray-100 pb-8 mb-10">
			...
			<p className="text-sm text-gray-500 mt-5">
				Showing <span className="font-bold text-gray-900">{totalCount}</span> categories
			</p>
		</div>
	);
}
