...
import { 
  FiChevronUp, FiChevronDown, FiMail, FiPhone, FiCalendar, 
  FiMapPin, FiStar, FiInfo, FiUserCheck, FiCreditCard, 
  FiDollarSign, FiTag 
} from 'react-icons/fi';
import { Button, LoadingSpinner } from '../../../../shared/ui/index.js';

// Accordion Section Component
export const AccordionSection = ({ title, icon, children, isOpen, onToggle }) => {
  return (
...
export const CustomerInformation = ({ user }) => (
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
...
export const PurchaseHistory = ({ orders, purchasedProducts, isLoadingOrders, page, setPage, totalPages }) => {
  if (isLoadingOrders) {
    return (
...
export const SellerInformation = ({ user, brands, total, totalPages, loadingBrands, page, setPage }) => {
