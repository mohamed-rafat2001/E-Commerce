...
const SellerInformation = ({ user }) => {
  ...
  const { brands, total, totalPages, loading: loadingBrands } = useSellerBrands(seller._id, page, 6);
...
const UserDetailsPage = () => {
  ...
  const { orders, purchasedProducts, isLoading: isLoadingOrders, totalPages } = useUserOrders(userId, ordersPage, 5);
