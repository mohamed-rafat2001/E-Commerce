						...
						<div className="flex items-center gap-6">
							...
							{isAuthenticated ? (
									...
									<AnimatePresence>
										{isDropdownOpen && (
											...
											>
												...
												<button onClick={() => { setIsDropdownOpen(false); setIsLogoutModalOpen(true); }} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors">
								...
								<div className="flex items-center gap-2">
									...
									<Link
										to="/register"
										className="px-6 py-2.5 bg-gray-900 text-white rounded-full text-sm font-black tracking-tight hover:bg-gray-800 transition-all shadow-lg active:scale-95"
									>
										Get Started
									</Link>
								</div>
			...
			<Modal isOpen={isLogoutModalOpen} onClose={() => setIsLogoutModalOpen(false)} title="Confirm Logout" size="sm">
				<div className="p-6 text-center">
					...
					<div className="flex gap-4">
						<Button variant="outline" className="flex-1" onClick={() => setIsLogoutModalOpen(false)}>Cancel</Button>
