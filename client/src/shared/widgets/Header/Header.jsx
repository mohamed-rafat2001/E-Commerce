						...
						{!isPanel && (
							<div className="flex items-center gap-10">
								...
								<nav className="hidden lg:flex items-center gap-8">
									<Link to="/products" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">Explore</Link>
									<Link to="/designers" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">Designers</Link>
									<Link to="/trending" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">Trending</Link>
								</nav>
							</div>
						)}
