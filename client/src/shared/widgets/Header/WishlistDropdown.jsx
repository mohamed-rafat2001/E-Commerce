...
const WishlistDropdown = ({ items = [], isLoading, viewAllPath, onRemove, onMoveToCart }) => {
	return (
		<motion.div
			...
			{items.length > 0 && (
				<div className="px-4 pt-3 border-t border-gray-50">
					<Link to={viewAllPath} className="block">
						<Button variant="secondary" fullWidth size="sm" icon={<FiArrowRight />} iconPosition="right">
							View All Products
						</Button>
					</Link>
				</div>
