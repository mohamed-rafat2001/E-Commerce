...
// @access  Private (any authenticated user)
export const getFollowStatus = catchAsync(async (req, res, _next) => {
	const { brandId } = req.params;
	const userId = req.user._id;
...
// @access  Public
export const getFollowersCount = catchAsync(async (req, res, _next) => {
	const { brandId } = req.params;
...
// @access  Private (any authenticated user)
export const getFollowedBrands = catchAsync(async (req, res, _next) => {
	const userId = req.user._id;
